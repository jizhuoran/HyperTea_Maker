...
private:
    ...
    BatchNormOp_GPU<half> bn1 = BatchNormOp_GPU<half> (8388608, 1, 32, 1e-05, 1, false, NULL, NULL, bn1_weight, bn1_bias);
    ...
    BatchNormOp_GPU<half> bn2 = BatchNormOp_GPU<half> (4194304, 1, 64, 1e-05, 1, false, NULL, NULL, bn2_weight, bn2_bias);
    ...
    BatchNormOp_GPU<half> bn3 = BatchNormOp_GPU<half> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, bn3_weight, bn3_bias);
    ...
    BatchNormOp_GPU<half> res1_bn1 = BatchNormOp_GPU<half> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res1_bn1_weight, res1_bn1_bias);
    ...
    BatchNormOp_GPU<half> res1_bn2 = BatchNormOp_GPU<half> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res1_bn2_weight, res1_bn2_bias);
    ...
    BatchNormOp_GPU<half> res2_bn1 = BatchNormOp_GPU<half> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res2_bn1_weight, res2_bn1_bias);
    ...
    BatchNormOp_GPU<half> res2_bn2 = BatchNormOp_GPU<half> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res2_bn2_weight, res2_bn2_bias);
    ...
    BatchNormOp_GPU<half> res3_bn1 = BatchNormOp_GPU<half> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res3_bn1_weight, res3_bn1_bias);
    ...
    BatchNormOp_GPU<half> res3_bn2 = BatchNormOp_GPU<half> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res3_bn2_weight, res3_bn2_bias);
    ...
    BatchNormOp_GPU<half> res4_bn1 = BatchNormOp_GPU<half> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res4_bn1_weight, res4_bn1_bias);
    ...
    BatchNormOp_GPU<half> res4_bn2 = BatchNormOp_GPU<half> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res4_bn2_weight, res4_bn2_bias);
    ...
    BatchNormOp_GPU<half> res5_bn1 = BatchNormOp_GPU<half> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res5_bn1_weight, res5_bn1_bias);
    ...
    BatchNormOp_GPU<half> res5_bn2 = BatchNormOp_GPU<half> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res5_bn2_weight, res5_bn2_bias);
    ...
    BatchNormOp_GPU<half> de_bn1 = BatchNormOp_GPU<half> (4194304, 1, 64, 1e-05, 1, false, NULL, NULL, de_bn1_weight, de_bn1_bias);
    ...
    BatchNormOp_GPU<half> de_bn2 = BatchNormOp_GPU<half> (8388608, 1, 32, 1e-05, 1, false, NULL, NULL, de_bn2_weight, de_bn2_bias);
